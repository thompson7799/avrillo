...
const { data: quotes, pending, refresh } = await useAsyncData(() =>
  useMakeRequest <{ data: Quote[] }>('api/ye-quotes', {
...
<template>
  <div>
    <div class="flex flex-col items-center justify-center">
      ...
      <div class="overflow-y-scroll h-[50vh]" v-if="quotes">
        <hr class="w-full" />
        <blockquote
          v-for="quoteItem in quotes"
          :key="quoteItem.quote"
          class="mt-4 py-2 px-10 w-full text-center text-xl font-semibold italic"
        >
          <svg
